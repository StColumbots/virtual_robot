 ...
 */
public class GamePadToggle2positionServo extends StColumbotsComponent {
    ...
    public GamePadToggle2positionServo(StColumbotsOpMode opMode, Gamepad gamepad, Servo servo,
