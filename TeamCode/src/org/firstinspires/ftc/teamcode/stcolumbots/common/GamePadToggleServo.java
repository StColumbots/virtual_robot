 ...
 */
public class GamePadToggleServo extends StColumbotsComponent {
    ...
    public GamePadToggleServo(StColumbotsOpMode opMode, Gamepad gamepad, ButtonControl buttonControl, Servo servo, double[] positions, boolean setPositionOnStart) {
        super(opMode);
    ...
    public GamePadToggleServo(StColumbotsOpMode opMode, Gamepad gamepad, ButtonControl buttonControl, Servo servo, double[] positions) {
