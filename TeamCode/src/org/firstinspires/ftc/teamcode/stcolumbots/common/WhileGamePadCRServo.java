 ...
 */
public class WhileGamePadCRServo extends StColumbotsComponent {
     ...
     */
    public WhileGamePadCRServo(StColumbotsOpMode opMode, Gamepad gamepad, CRServo crservo, ButtonControl buttonControl, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public WhileGamePadCRServo(StColumbotsOpMode opMode, Gamepad gamepad, CRServo crservo , ButtonControl buttonControl, float power) {
