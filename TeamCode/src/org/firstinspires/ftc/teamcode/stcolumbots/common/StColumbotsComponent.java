...
public class StColumbotsComponent {

    private StColumbotsOpMode opMode;

    public StColumbotsComponent(StColumbotsOpMode StColumbotsOpMode) {
        opMode = StColumbotsOpMode;
    }

    protected StColumbotsOpMode getOpMode() {
        return opMode;
    }
