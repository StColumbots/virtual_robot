...
public class GamePadSteerDrive extends StColumbotsComponent {

    final private DcMotor leftMotor;
    final private DcMotor rightMotor;
    final private Gamepad gamepad;

    public GamePadSteerDrive(StColumbotsOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor) {
        super(opMode);
