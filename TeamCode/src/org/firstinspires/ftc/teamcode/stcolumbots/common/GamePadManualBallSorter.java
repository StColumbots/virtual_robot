 ...
 */
public class GamePadManualBallSorter extends StColumbotsComponent {
    ...
    public GamePadManualBallSorter(StColumbotsOpMode opMode, Gamepad gamepad, Servo sorterservo) {
        super(opMode);
