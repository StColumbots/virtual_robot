 ...
 */
public class GamePadToggleMotorWithRevers extends StColumbotsComponent {
     ...
     */
    public GamePadToggleMotorWithRevers(StColumbotsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleMotorWithRevers(StColumbotsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power) {
