...
@TeleOp(name = "RowanOPMode", group = "TwoWheel")
public class TwoWheelDemoOpModemyown extends OpMode {
    ...
    public void loop() {
        ...
        left.setPower(-gamepad1.left_stick_y + (gamepad1.right_stick_x / speed));
        right.setPower(-gamepad1.left_stick_y - (gamepad1.right_stick_x / speed));

        backServo.setPosition(0.5 - 0.5 * gamepad1.right_trigger);
