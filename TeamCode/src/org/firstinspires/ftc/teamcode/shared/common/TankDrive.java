...
public class TankDrive extends RobotComponent {
    ...
    public TankDrive(RobotOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor, double countsPerCm) {
        super(opMode);
    ...
    public TankDrive(RobotOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor) {
