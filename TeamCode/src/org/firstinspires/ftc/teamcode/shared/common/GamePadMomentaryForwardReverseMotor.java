 ...
 */
public class GamePadMomentaryForwardReverseMotor extends RobotComponent {
     ...
     */
    public GamePadMomentaryForwardReverseMotor(RobotOpMode opMode, Gamepad gamepad, final DcMotor motor, TouchSensor stopSensor,
    ...
    public GamePadMomentaryForwardReverseMotor(RobotOpMode opMode, Gamepad gamepad, DcMotor motor, TouchSensor stopSensor,
                                               ButtonControl forwardButtonControl, ButtonControl reverseButtonControl,
                                               float power) {
