 ...
 */
public class GamePadToggleMotorWithReverse extends RobotComponent {
     ...
     */
    public GamePadToggleMotorWithReverse(RobotOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleMotorWithReverse(RobotOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power) {
