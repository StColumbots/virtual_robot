...
//        tasks.add(new MecanumDriveTask(this, 1, drive, 1, 0, 0));
        tasks.add(new GoToTask(this, 10, drive, config.otos, 0, 600, 0, 0.5, 10, 2));
        tasks.add(new GoToTask(this, 10, drive, config.otos, 600, 0, 45, 0.5, 10, 2));
        tasks.add(new GoToTask(this, 10, drive, config.otos, 0, -600, 0, 0.5, 10, 2));
        tasks.add(new GoToTask(this, 10, drive, config.otos, -600, -600, 0, 0.5, 10, 2));
